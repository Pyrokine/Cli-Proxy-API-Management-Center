...
export function ConfigPage() {
    ...
    const loadConfig = useCallback(async () => {
        ...
        try {
            ...
            loadVisualValuesFromYaml(merged)
        } catch (err: unknown) {
    ...
    const getStatusText = () => {
        if (disableControls) {
            return t('config_management.status_disconnected')
        }
        if (loading) {
            return t('config_management.status_loading')
        }
        if (error) {
                             ...
                             : t('config_management.search_no_results', {
                                    defaultValue: '无结果',
                                                 ...
                                                 <button
                                                     ...
                                                     title={t(
                                                         'config_management.search_button',
                                                         { defaultValue: '搜索' },
                                                     )}
                                                 >
                                                     <IconSearch size={16} />
