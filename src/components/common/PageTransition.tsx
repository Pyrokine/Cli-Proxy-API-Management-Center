...
export function PageTransition({
    ...
    useLayoutEffect(() => {
        ...
        if (location.key === currentLayerKey) {
            return
        }
    ...
    useLayoutEffect(() => {
        ...
        if (!activeAnimations.length) {
            ...
            void Promise.all(activeAnimations.map((animation) => animation.finished.catch(() => undefined)))
                        .then(() => {
                    ...
                    return (
                        <div
                            ...
                            ref={
                                ...
                                exitingLayerRef :
                                layer.status === 'current' ? currentLayerRef : undefined
                            }
                        >
