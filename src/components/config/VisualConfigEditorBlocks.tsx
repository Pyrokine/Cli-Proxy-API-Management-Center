...
const PLUGIN_STORE_AUTH_TYPE_OPTIONS: Array<{ value: PluginStoreAuthType; labelKey: string; defaultLabel: string }> = [
    {
        value: 'bearer',
        labelKey: 'config_management.visual.sections.system.store_auth_type_bearer',
        defaultLabel: 'Bearer',
    },
    {
        value: 'github-token',
        labelKey: 'config_management.visual.sections.system.store_auth_type_github_token',
        defaultLabel: 'GitHub Token',
    },
    {
        value: 'basic',
        labelKey: 'config_management.visual.sections.system.store_auth_type_basic',
        defaultLabel: 'Basic',
    },
    {
        value: 'header',
        labelKey: 'config_management.visual.sections.system.store_auth_type_header',
        defaultLabel: 'Custom Header',
    },
    {
        value: 'none',
        labelKey: 'config_management.visual.sections.system.store_auth_type_none',
        defaultLabel: 'None',
    },
]
            ...
            {value.length === 0 ? (
                <p className={styles.storeAuthEmpty}>
                    {t('config_management.visual.sections.system.store_auth_empty', {
                        defaultValue: 'No auth rules configured. Public plugin sources do not need one.',
                    })}
                </p>
            ) : null}
            {value.map((rule) => {
                    ...
                    <div key={rule.id} className={styles.storeAuthRule}>
                        ...
                        <div className={styles.storeAuthGrid}>
                            <label className={styles.storeAuthField}>
                                <span>{t('config_management.visual.sections.system.store_auth_match', {
                                    defaultValue: 'Match URL prefix',
                                })}</span>
                                <input
                                    className='input'
                                    value={rule.match}
                            ...
                            <label className={styles.storeAuthField}>
                                <span>{t('config_management.visual.sections.system.store_auth_type', {
                        ...
                        <div className={styles.storeAuthApplyTo}>
                            <span>{t('config_management.visual.sections.system.store_auth_apply_to', {
                            ...
                            <small>
                                {t('config_management.visual.sections.system.store_auth_apply_to_hint', {
                                    defaultValue: 'When empty, the rule applies to all plugin store request types.',
                                })}
                            </small>
                        </div>
                        ...
                        {usesToken ? (
                            <label className={styles.storeAuthField}>
                                <span>{t('config_management.visual.sections.system.store_auth_token_env', {
                                    defaultValue: 'Token environment variable',
                                })}</span>
                                <input
                                    className='input'
                                    value={rule.tokenEnv}
                                    placeholder='CPA_PLUGIN_STORE_TOKEN'
                                    disabled={disabled}
                        ...
                        {usesBasic ? (
                            <div className={styles.storeAuthGrid}>
                                <label className={styles.storeAuthField}>
                                    <span>{t('config_management.visual.sections.system.store_auth_username_env', {
                                        defaultValue: 'Username environment variable',
                                    })}</span>
                                    <input
                                        className='input'
                                ...
                                <label className={styles.storeAuthField}>
                                    <span>{t('config_management.visual.sections.system.store_auth_password_env', {
                                        defaultValue: 'Password environment variable',
                                    })}</span>
                                    <input
                                        className='input'
                        ...
                        {usesHeader ? (
                            <div className={styles.storeAuthGrid}>
                                <label className={styles.storeAuthField}>
                                    <span>{t('config_management.visual.sections.system.store_auth_header_name', {
                                ...
                                <label className={styles.storeAuthField}>
                                    <span>{t('config_management.visual.sections.system.store_auth_header_value_env', {
                                        defaultValue: 'Header value environment variable',
                                    })}</span>
                                    <input
                                        className='input'
                                        ...
                                        onChange={(event) => updateRule(
                                            rule.id,
                                            { headerValueEnv: event.target.value },
                                        )}
                                    />
                                </label>
                            </div>
                        ...
                        <label className={styles.storeAuthCheckbox}>
                            ...
                            />
                            <span>{t('config_management.visual.sections.system.store_auth_allow_insecure', {
                                defaultValue: 'Allow insecure HTTP URLs',
                            })}</span>
                        </label>
                    </div>
                )
