        ...
        <Modal
            ...
            footer={
                <>
                    ...
                    <Button onClick={onConfirm} loading={loading} disabled={loading || hasErrors}>
            ...
            <div className={styles.content}>
                {errors.length > 0 && (
                    <div className={styles.validationErrors}>
                        <strong>{t('config_management.validation.errors_title')}</strong>
                        <ul>
                            {errors.map((err, i) => (
                ...
                {warnings.length > 0 && (
                    <div className={styles.validationWarnings}>
                        <strong>{t('config_management.validation.warnings_title')}</strong>
                        <ul>
                            {warnings.map((w, i) => (
                                <li key={i}>{w}</li>
                            ))}
                             ...
                             {diff.hunks.map((hunk, hunkIdx) => (
                                 <div key={hunkIdx} className={styles.hunk}>
                                     ...
                                     {hunk.lines.map((line, lineIdx) => (
                                         ...
                                         >
                                            <span
                                                className={`${styles.lineNum} ${line.oldNum === null ?
                                                                                styles.lineNumEmpty :
                                                                                ''}`}
                                            >
                                                {line.oldNum ?? ''}
                                             ...
                                             <span
                                                 className={`${styles.lineNum} ${
                                                     line.newNum === null ? styles.lineNumEmpty : ''
                                                 }`}
                                             >
                                                {line.newNum ?? ''}
                                            </span>
